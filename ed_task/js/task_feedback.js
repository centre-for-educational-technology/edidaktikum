(function ($) {
  Drupal.behaviors.ed_task_feedback = {
    attach: function (context, settings) {
      ...
      var emotions_results = [
        {
          value: emotions.curiosity,
          label: Drupal.t('Uudishimu'),
          color: '#27f59d'
        },
        {
          value: emotions.confusion,
          label: Drupal.t('Segadus'),
          color: '#3399FF'
        },
        {
          value: emotions.anxiety,
          label: Drupal.t('Ärevus'),
          color: '#FFC575'
        },
        {
          value: emotions.boredom,
          label: Drupal.t('Igavus'),
          color: '#99CC00'
        },
        {
          value: emotions.surprise,
          label: Drupal.t('Üllatus'),
          color: '#FF3300'
        },
        {
          value: emotions.frustration,
          label: Drupal.t('Frustratsioon'),
          color: '#944DDB'
        },
        {
          value: emotions.enjoyment,
          label: Drupal.t('Rõõm'),
          color: '#fff45c'
        },
      ];
       ...
       ***********************************************************/
      var donutSize = 300;
      var donut = $('#animated-chart-emotions').donut({
        donutSize: donutSize,
        center: {
          x: donutSize / 2,
          y: donutSize / 2
