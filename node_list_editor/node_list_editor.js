...
(function() {
	...
	class taxonomy_item {
		constructor(node, parent, callback_changed) {
			this.node = node;
			this.parent = parent;
	...
	class node_list_editor {
		...
		get current_item() { return this._current_item; }
